...
class EditContactScreeen extends StatelessWidget {
  const EditContactScreeen({super.key});

  @override
  Widget build(BuildContext context) {
    return const Scaffold(
        backgroundColor: AppColor.black, body: EditContactScreenBody());
  }
}

class EditContactScreenBody extends StatelessWidget {
  const EditContactScreenBody({
    super.key,
  });
